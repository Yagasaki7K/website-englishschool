        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 text-center">
                <div class="site-info-text"> 
                    ...
                    <?php } ?>                   
                    <p><?php esc_html_e('Theme : ','online-courses'); ?><a href="<?php echo esc_url('https://wpdigipro.com/wordpress-themes/online-courses/'); ?>"><?php esc_html_e(' Online Courses WordPress Theme','online-courses'); ?></a></p>
                </div>
            </div>
        </div>
    </div> 
